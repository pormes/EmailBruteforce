...
#Copyright of Pormes17(anonymous_dikha). Do NOT copy it as yours. This code is only to learn the python cybersecurity.
...
def title_setup():
    ...
    print "Script By Mr.Pormes17"
    print "Support Me And Subscribe My Channels Pormes17"
    print "This Code Is A Real Python Program CyberSecurity"
    print "Type of tools : Penetration Test Tools"
    print "Group of indonesian-hacktivist"
    print ""
    print ""
    print(title)
...
if __name__ == "__main__":
    ...
    confirmation = "Y"
    negation = "N"
    print "Remember : when the program is executing and watch your email, and if the brutefrce worked you will recive a mail with the password"
